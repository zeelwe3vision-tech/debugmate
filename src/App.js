...
import CreateMail from './pages/Role-management/createmail';
import Announcements from './pages/Announcements';
import ChatbotIcon from './component/ChatbotIcon';
import SignIn from './pages/Signin';
import ProjectInfo from './pages/chatbot/project_info.js';
      ...
      <div className="main d-flex">
        ...
        <div className={`content ${ishideSidebar===true && 'full'} ${istoggleSidebar===true ? 'open' : ''}`}>
          <Routes>
            ...
            <Route path="/chatbot/project-info" element={<ProjectInfo/>} />
