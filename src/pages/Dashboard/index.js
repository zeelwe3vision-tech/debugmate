...
import { FiMoreHorizontal, FiFilter, FiHeart, FiPlus,} from 'react-icons/fi';
...
const Dashboard = () => (
  <Container fluid className="dashboard-container">
    <Row className="g-8 mb-4 justify-content-center">
      <Col md={3} sm={6} xs={12}><StatCard value="04" title="Open Project" /></Col>
      <Col md={3} sm={6} xs={12}><StatCard value="02" title="Project Completed" /></Col>
      <Col md={3} sm={6} xs={12}><StatCard value="45.99" title="Total Project Hours" /></Col>
    </Row>
    <Row>
      <Col>
